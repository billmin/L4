...
def listener():
	...
	wheel_base = cp.get(section, "wheel_base")
	width = cp.get(section, "width")
	dist_from_front_wheel_to_head = cp.get(section, "front_wheel_to_head")
	dist_from_rear_wheel_to_tail = cp.get(section, "rear_wheel_to_tail")
	## pose
